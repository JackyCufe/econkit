...
def gen_dataset1():
    ...
    df.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'test_data.csv'), index=False)
...
def gen_dataset2():
    ...
    df = pd.DataFrame(rows)
    df.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_health.csv'), index=False)
...
def gen_dataset3():
    ...
    df = pd.DataFrame(rows)
    df.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_digital.csv'), index=False)
...
def gen_dataset4():
    ...
    df.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data_rdd.csv'), index=False)
